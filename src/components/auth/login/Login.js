...
//                     <input id="email" type="email" className="form-control" name="email" tabIndex={1} required autoFocus onChange={this.handleChange}  />
...
//                       </div>
//                     </div>
//                     <input id="password" type="password" className="form-control" name="password" tabIndex={2} required onChange={this.handleChange}/>
//                     <div className="invalid-feedback">
...
//                   </div>
//                   <div className="form-group">
//                     <button type="submit" className="btn btn-primary btn-lg btn-block" tabIndex={4} onClick={this.handleClick}>
//                       Login
//                     </button>
//                   </div>
//                 </form>
